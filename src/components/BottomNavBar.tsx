...
const BottomNavBar: React.FC = () => {
    ...
    if (isAdmin) {
        navItems.push({ to: "/admin", icon: ShieldCheckIcon, label: "Админ", end: false });
    }
    
    const baseLinkClass = 'flex flex-col items-center justify-center h-12 w-1/5 rounded-2xl transition-all duration-300 ease-in-out transform';
